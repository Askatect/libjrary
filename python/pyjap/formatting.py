...
def sqlformatterv5(query):
	...
	LOG.info('Identifying terms in SQL query...')
	...
	LOG.info('Formatting terms in SQL query...')
	...
	LOG.info('Formatting lines in SQL query...')
	...
	LOG.info('Final formatting of SQL query...')
	...
	LOG.info('Returning formatted query.')
